...
**ForgePack** — это высокопроизводительный self-hosted Telegram-бот, на **Go** с использованием интеграции легковесных ai. 
...
1. Склонируйте репозиторий:
   ```bash
   git clone https://github.com/Vim-01/ForgePack.git
   cd forgepack
   ```
